...
#include "GASTPSAttributeSet.generated.h"
 ...
 */
UCLASS()
class UGASTPSAttributeSet : public UAttributeSet
{
	GENERATED_BODY()
	
public:
	ATTRIBUTE_ACCESSORS(UGASTPSAttributeSet, Health)
	ATTRIBUTE_ACCESSORS(UGASTPSAttributeSet, MaxHealth)
	ATTRIBUTE_ACCESSORS(UGASTPSAttributeSet, Mana)
	ATTRIBUTE_ACCESSORS(UGASTPSAttributeSet, MaxMana)
